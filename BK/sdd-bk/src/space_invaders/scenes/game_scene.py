...
class GameScene(Scene):
    GAMEPLAY_BACKGROUND_ID = "bg_stars_seamless"
    ...
    def _spawn_wave(self) -> None:
        ...
        formation_width = (config.cols - 1) * self._enemy_factory.SPACING_X + 20
        start_x = max(12.0, (480 - formation_width) / 2)
    ...
    def render(self) -> None:
        ...
        background_id = self.GAMEPLAY_BACKGROUND_ID
